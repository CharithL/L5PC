#!/usr/bin/env python3
"""Run ONLY sub-11 zombie test. Sub-10 already done — see zombie_iaaft_test_v2.log."""
import sys, os
...
log.info("=" * 70)
log.info("ZOMBIE TEST: sub-11 (original LSTM h32, CC=0.542, NOT retrained)")
log.info("=" * 70)

session_data = load_session(KYZAR_DATA, KYZAR_MODELS, 11, hidden_dim=32)
...
log.info("  Phase 3: %d/18 passed dual gate", n_pass)

log.info("  Running Phase 4 ablation...")
p4 = run_phase4_iaaft(session_data, p3)

mandatory = extract_mandatory(p4)
log.info("")
log.info("  RESULT: sub-11 (original h32)")
